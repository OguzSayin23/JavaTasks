...
public class Number_LovelyNumber {
    ...
    */
     public static void main(String[] args) {
         System.out.println(lovelyNum(11));
         System.out.println(lovelyNumberCount(0,0));
     }

     public static int lovelyNumberCount(int a, int b){
         int count = 0;
         for (int i = a; i <= b; i++) {
             if (lovelyNum(i)) {
                 count++;
    ...
    public static boolean lovelyNum(int a){
        boolean flag = true;
